                ...
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h1 className="text-2xl font-black tracking-tight text-[#4722B3]">{adjustment.number}</h1>
                        </div>
                    </div>
                ...
                <div className="space-y-6">
                    <section className="overflow-hidden rounded-[24px] border border-[#E5EAF3] bg-white shadow-[0_2px_16px_rgba(0,0,0,0.02)]">
                        <header className="border-b border-[#E5EAF3] px-7 py-6">
                            <div className="grid gap-4 md:grid-cols-5">
                                <div className="rounded-xl bg-[#f8f9fb] px-5 py-4">
                                    ...
                                    <div className="mt-1 text-[20px] font-black text-[#4722B3]">{adjustment.date_label}</div>
                                </div>
                                <div className="rounded-xl bg-[#f8f9fb] px-5 py-4">
                                    <div className="text-[10px] font-black uppercase tracking-[0.16em] text-gray-400">SKU Koreksi</div>
                                    <div className="mt-1 text-[20px] font-black text-[#4722B3]">{formatNumber(adjustment.items_count)}</div>
                                </div>
                        ...
                        <main className="grid gap-7 px-7 py-7 lg:grid-cols-[1fr_0.82fr]">
                            <section>
                                <h2 className="mb-4 text-[13px] font-black uppercase tracking-[0.14em] text-[#4722B3]">Item Adjustment</h2>
                            ...
                            <aside>
                                <h2 className="mb-4 text-[13px] font-black uppercase tracking-[0.14em] text-[#4722B3]">Rincian Adjustment</h2>
