...
export default function WarehouseFloorPlan({ zoneSummaries, rackSummaries, selectedZone, selectedRack, warehouseName }) {
        ...
        return (
            <g key={zone.id}>
                <rect x={x} y={y} width={w} height={h}
                    fill={zone.pal.bg} stroke={isSelected ? '#4722B3' : zone.pal.border}
    ...
    return (
        <div className="rounded-[24px] border border-[#E5EAF3] bg-white p-7 shadow-[0_2px_16px_rgba(0,0,0,0.02)]">
            {/* Header */}
            <div className="mb-5 flex items-center justify-between gap-4">
                <div>
                    <h3 className="text-[18px] font-black text-[#4722B3]">Visualisasi Denah Gudang</h3>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="ml-2 rounded-full bg-[#eef2ff] px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-[#4722B3]">
                        Interaktif
                    </span>
                </div>
            </div>
            ...
            <div
                ref={containerRef}
                className="relative overflow-hidden rounded-[18px] border border-[#E5EAF3] bg-[#f5f5f0]"
            ...
            >
                ...
                {tooltip && (
                    ...
                    >
                        {tooltip.text.split('\n').map((line, i) => (
                            <div key={i} className={`text-[11px] font-semibold ${i === 0 ? 'font-black text-[#4722B3]' : 'text-gray-500'}`}>
                                {line}
                            </div>
                        ))}
                    </div>
